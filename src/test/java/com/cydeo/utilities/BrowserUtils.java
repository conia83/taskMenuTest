...
public class BrowserUtils {
    ...
    /**
     * this method will accept a String as a expected value and verify actual Url contains the value
     * @param expectedInUrl
     */
    ...
    public static List<String> dropdownOptionsAsString(WebElement dropdownElement){
        ...
        List<WebElement> actualMonthsList = select.getOptions();

        List<String> actualMonthsAsString = new ArrayList<>();

        for (WebElement eachMonth : actualMonthsList) {
